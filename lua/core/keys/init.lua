...
function M.native()
    ...
    -- Buffers
    keymap(n, "Q", function() require("core.keys.utils").delete_buffer() end, default_settings)
...
function M.oil()
    keymap(n, "<leader>e", function() require("core.keys.utils").toggle_oil() end)
    require("oil").setup({
        keymaps = {
            ["<CR>"] = "actions.select",
            ["-"] = "actions.parent",
...
function M.editing()
    ...
    keymap(
        ex_t,
        "<C-s>",
        function() require("core.keys.utils").save_file() end,
        default_settings
    )
...
function M.debugger()
    ...
    keymap(
        n,
        "<leader>s",
        function() require("core.keys.utils").dap_float_scope() end,
        default_settings
    )
    keymap(
        n,
        "<F1>",
        function() require("core.keys.utils").dap_toggle_ui() end,
        default_settings
    )
